...
export class EmployeeEdit extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { id: 0, fullName: '', birthdate: '', tin: '', employeeTypeId: 1, loading: true, loadingSave: false, Khalid: 'Mira-ato' };
    }
    ...
    async getEmployee(id) {
        ...
        this.setState({ id: data.id, fullName: data.fullName, birthdate: data.birthdate.toString().split('T')[0], tin: data.tin, employeeTypeId: data.employeeTypeId, loading: false, loadingSave: false });
    }
}
